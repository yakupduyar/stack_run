...
public class StackController : MonoBehaviour
{
    ...
    private float _xDelta, _realPathMoveSpeed,_realSpawnSpan;
    ...
    [HideInInspector] public PathEvent onPathPlaced = new PathEvent();
    ...
    private void Init()
    {
        _realPathMoveSpeed = pathMoveSpeed;
        _realSpawnSpan = spawnSpan;
    ...
    {
        _currentPath.Translate(Vector3.left * Time.deltaTime * _realPathMoveSpeed);
    }
    ...
    private void PlacePath()
    {
        ...
        else if (Mathf.Abs(_xDelta) < _lastPathScale.x)
        {
            ...
            _currentPath.localPosition =
                new Vector3(_lastPathPosition.x + _xDelta * .5f, 0, _currentPath.localPosition.z);
    ...
    private void SpawnPath()
    {
        ...
        newPath.localPosition = _lastPathPosition + Vector3.right * _realSpawnSpan + Vector3.forward * _lastPathScale.z;
    ...
    public void NextLevel()
    {
        ...
        Init();
        _currentPath = pathsParent.GetChild(0);
        _currentPath.localScale = pathPrefab.localScale;
        _currentPath.position = LevelManager.Instance.StartPathPos + Vector3.forward * PathLength;
    }
}